...
<div className="main-container flex w-full xl:w-[1440px] pt-[96px] pr-0 pb-[96px] pl-0 flex-col gap-[48px] items-center flex-nowrap relative mx-auto my-0">
      <div className="flex w-full xl:w-[693px] flex-col gap-[16px] justify-center items-end shrink-0 flex-nowrap relative">
        ...
        <span className="flex xl:w-[693px] xl:h-[87px] justify-center items-start shrink-0  text-[16px] font-medium leading-[29.12px] text-[#dbdbdb] relative text-center overflow-hidden z-[3]">
          كن جزءًا من لقاء القهوة السعودي الأوغندي!
          <br />
          سجل الآن للمشاركة في هذا الحدث المميز، واستمتع بعروض حصرية، وتفاعل مع
          خبراء الصناعة، عشاق القهوة، وأشخاص يشاركونك نفس الاهتمامات.
        </span>
      </div>
